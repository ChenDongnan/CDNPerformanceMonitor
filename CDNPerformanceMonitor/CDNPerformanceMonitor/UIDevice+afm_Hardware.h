...
typedef NS_ENUM(NSInteger,UIDeviceCPUPerformanceType) {
    ...
    UIDevice_CPU_A10 = 11,      // iPhone(7、7 plus)
    UIDevice_CPU_A10X = 12,     // iPad Pro（10.5寸）
    UIDevice_CPU_A11 = 13,      // iPhone(8、 8 plus、X)
    UIDevice_CPU_A12 = 14,      // iPhone(Xs、 Xs Max、Xr)
...
@interface UIDevice (afm_Hardware)
- (NSString *) platform;
- (NSString *) hwmodel;
